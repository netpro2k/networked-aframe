...
var options = __webpack_require__(379);
var utils = __webpack_require__(380);
var physics = __webpack_require__(381);
var NafLogger = __webpack_require__(382);
var Schemas = __webpack_require__(383);
var NetworkEntities = __webpack_require__(384);
var NetworkConnection = __webpack_require__(386);
...
var NafInterface = __webpack_require__(387);
...
var _undefined = __webpack_require__(131)(); // Support ES3 engines
...
var assign        = __webpack_require__(351)
  ...
  , isCallable    = __webpack_require__(357)
...
var from         = __webpack_require__(95)
  , primitiveSet = __webpack_require__(67);
...
var deepEqual = __webpack_require__(136);
...
var templateString = __webpack_require__(343);
...
var compile = __webpack_require__(344)
...
var esniff = __webpack_require__(345)
...
var from         = __webpack_require__(95)
  ...
  , callable     = __webpack_require__(133)
  , d            = __webpack_require__(130)
  , eolSet       = __webpack_require__(134)
  , wsSet        = __webpack_require__(371)
...
var iteratorSymbol = __webpack_require__(348).iterator
  , isArguments    = __webpack_require__(363)
  , isFunction     = __webpack_require__(364)
  , toPosInt       = __webpack_require__(365)
  , callable       = __webpack_require__(133)
  , validValue     = __webpack_require__(66)
  , isValue        = __webpack_require__(65)
  , isString       = __webpack_require__(370)
...
module.exports = __webpack_require__(349)() ? Symbol : __webpack_require__(350);
...
var d              = __webpack_require__(130)
  , validateSymbol = __webpack_require__(361)
...
var objToString = Object.prototype.toString, id = objToString.call(__webpack_require__(131));
...
var sign = __webpack_require__(367)
...
var primitiveSet = __webpack_require__(67)
  , eol          = __webpack_require__(134)
  , inline       = __webpack_require__(372);
...
var resolve  = __webpack_require__(374)
  , passthru = __webpack_require__(376);
...
var value          = __webpack_require__(66)
  ...
  , isVarNameValid = __webpack_require__(375)
...
var almostEqual = __webpack_require__(378);
/**
...
var ChildEntityCache = __webpack_require__(385);
...
var INetworkAdapter = __webpack_require__(47);
...
var naf = __webpack_require__(29);
var adapterFactory = __webpack_require__(389);
...
var WsEasyRtcAdapter = __webpack_require__(390);
var EasyRtcAdapter = __webpack_require__(391);
var UwsAdapter = __webpack_require__(392);
var FirebaseWebRtcAdapter = __webpack_require__(393);
var JanusAdapter = __webpack_require__(397);
...
var naf = __webpack_require__(29);
var INetworkAdapter = __webpack_require__(47);
var firebaseKeyEncode = __webpack_require__(394);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(68), __webpack_require__(396)(module)))
...
class JanusAdapter extends INetworkAdapter {
  ...
  onWebsocketOpen() {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this.sessionId = yield _this.sendCreateSession();
      ...
      var publisherEvents = _this.messageIterator(function (msg) {
        return msg.janus && msg.janus === "event" && msg.sender && msg.sender === publisher.handleId;
      });
      ...
      _this.userId = publisher.userId;
      _this.connectSuccess(publisher.userId);
      ...
      for (let occupantId of publisher.initialOccupants) {
        if (occupantId !== publisher.userId) {
          ...
          _this.addOccupant(publisher.handleId, occupantId);
        }
      }
      ...
      try {
        for (var _iterator = _asyncIterator(publisherEvents), _step, _value; _step = yield _iterator.next(), _iteratorNormalCompletion = _step.done, _value = yield _step.value, !_iteratorNormalCompletion; _iteratorNormalCompletion = true) {
          let message = _value;
          ...
          if (data.event && data.event === "join") {
            ...
            _this.addOccupant(publisher.handleId, data.user_id);
          } else if (data.event && data.event === "leave") {
            // DEBUG
            console.log("onLeave", { userId: data.user_id });
            _this.removeOccupant(data.user_id);
          }
        }
      } catch (err) {
  ...
  addOccupant(publisherHandle, occupantId) {
    var _this2 = this;

    return _asyncToGenerator(function* () {
      var subscriber = yield _this2.createSubscriber(publisherHandle, occupantId);
      _this2.occupantMediaStreams[occupantId] = subscriber.mediaStream;
  ...
  createPublisher() {
    ...
    return _asyncToGenerator(function* () {
      var handleId = yield _this3.sendAttachSFUPlugin();

      var peerConnection = new RTCPeerConnection(PEER_CONNECTION_CONFIG);

      peerConnection.addEventListener("icecandidate", function (event) {
        return _this3.sendIceCandidate(handleId, event.candidate);
      });
      ...
      try {
        for (var _iterator2 = _asyncIterator(_this3.sendJoin(handleId, offer)), _step2, _value2; _step2 = yield _iterator2.next(), _iteratorNormalCompletion2 = _step2.done, _value2 = yield _step2.value, !_iteratorNormalCompletion2; _iteratorNormalCompletion2 = true) {
          let message = _value2;

          if (message.jsep) {
            // DEBUG
            console.log("createPublisher received: jsep");
            yield peerConnection.setRemoteDescription(message.jsep);
          } else if (
          // TODO: Can we flatten this data structure?
          // TODO: Can we use an initial event type?
          message.plugindata && message.plugindata.data && message.plugindata.data.response) {
  ...
  createSubscriber(publisherHandle, occupantId) {
    var _this4 = this;

    return _asyncToGenerator(function* () {
      // Start receiving data for this occupant on the publicher peer connection.
      yield _this4.subscribeTo(publisherHandle, occupantId, ContentKind.Data);

      var handleId = yield _this4.sendAttachSFUPlugin();

      var peerConnection = new RTCPeerConnection(PEER_CONNECTION_CONFIG);

      peerConnection.addEventListener("icecandidate", function (event) {
        return _this4.sendIceCandidate(handleId, event.candidate);
      });
      ...
      try {
        for (var _iterator3 = _asyncIterator(_this4.sendJoin(handleId, offer)), _step3, _value3; _step3 = yield _iterator3.next(), _iteratorNormalCompletion3 = _step3.done, _value3 = yield _step3.value, !_iteratorNormalCompletion3; _iteratorNormalCompletion3 = true) {
          let response = _value3;

          if (response.jsep) {
            // DEBUG
            console.log("createSubscriber received: jsep");
            yield peerConnection.setRemoteDescription(response.jsep);
            break;
          }
        }
      ...
      yield _this4.subscribeTo(handleId, occupantId, ContentKind.Audio);
  ...
  sendCreateSession() {
    ...
    return _asyncToGenerator(function* () {
      ...
      var response = yield _this5.transactionPromise({ janus: "create" });
  ...
  sendAttachSFUPlugin() {
    ...
    return _asyncToGenerator(function* () {
      ...
      var response = yield _this6.transactionPromise({
        janus: "attach",
        session_id: _this6.sessionId,
  ...
  sendSubscribe(handleId, specs) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        for (var _iterator4 = _asyncIterator(_this7.transactionIterator(signal)), _step4, _value4; _step4 = yield _iterator4.next(), _iteratorNormalCompletion4 = _step4.done, _value4 = yield _step4.value, !_iteratorNormalCompletion4; _iteratorNormalCompletion4 = true) {
          let message = _value4;
  ...
  transactionPromise(message) {
    ...
    return this.messagePromise(message => message.transaction && message.transaction === transactionId);
  }

  transactionIterator(message) {
    var transactionId = this.sendSignal(message);
    return this.messageIterator(message => message.transaction && message.transaction === transactionId);
  }
  ...
  getAudioStream(clientId) {
    ...
    return Promise.resolve(this.occupantMediaStreams[clientId]) || Promise.reject(`No media stream for client: ${clientId}`);
  }
...
var naf = __webpack_require__(29);
var componentHelper = __webpack_require__(135);
var Compressor = __webpack_require__(137);
